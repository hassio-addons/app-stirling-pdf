...
[**Report a vulnerability**](https://github.com/hassio-addons/app-stirling-pdf/security/advisories/new)
...
- Issues in Stirling PDF itself; please report those directly to the
  [Stirling PDF project](https://github.com/Stirling-Tools/Stirling-PDF/security/policy).
...
This security policy covers the Stirling PDF app in this repository: the app
